...
<div class="page-wrapper">
    ...
    <div class="page-header">
        <div class="header-left">
            ...
            <div class="header-title">
                <h1>Tambah Dosen</h1>
                <p>Isi form berikut untuk mendaftarkan dosen baru</p>
            </div>
        </div>
    </div>
    ...
    <div class="form-card">
        <div class="info-banner">
            ...
            <span>Akun login dibuat otomatis — Email: <strong>email dosen</strong> &nbsp;&bull;&nbsp; Password default: <strong>NIDN</strong></span>
        </div>
...
<style>
    ...
    .info-banner { display: flex; align-items: center; gap: .6rem; background: #eff6ff; border: 1px solid #bfdbfe; color: #1d4ed8; border-radius: 8px; padding: .75rem 1rem; font-size: .84rem; margin-bottom: 1.75rem; }
